...
const firebaseConfig = {
  apiKey: "AIzaSyAPczg2iab-tE411pSH7CqpH3Kn5-RUbZc",
  authDomain: "cv-react-ts.firebaseapp.com",
  projectId: "cv-react-ts",
  storageBucket: "cv-react-ts.appspot.com",
  messagingSenderId: "839611932315",
  appId: "1:839611932315:web:1334198292145e6e5f703e",
};
...
export const createUserDocumentFromAuth = async (
  ...
  //
  console.log("SNAP", userSnapshot, "SNAP.exists", userExists);
  //
  if (!userExists) {
